...
_sym_db.RegisterEnumDescriptor(_NETGAMEMODE)
...
_sym_db.RegisterEnumDescriptor(_NETGAMESTATE)
...
_sym_db.RegisterEnumDescriptor(_NETPLAYERACTION)
...
_sym_db.RegisterEnumDescriptor(_NETPLAYERSTATE)
...
_sym_db.RegisterEnumDescriptor(_NETPLAYERINFORIGHTS)
...
_sym_db.RegisterEnumDescriptor(_NETAVATARTYPE)
...
_sym_db.RegisterEnumDescriptor(_NETGAMEINFO_NETGAMETYPE)
...
_sym_db.RegisterEnumDescriptor(_NETGAMEINFO_RAISEINTERVALMODE)
...
_sym_db.RegisterEnumDescriptor(_NETGAMEINFO_ENDRAISEMODE)
...
_sym_db.RegisterEnumDescriptor(_ANNOUNCEMESSAGE_SERVERTYPE)
...
_sym_db.RegisterEnumDescriptor(_INITMESSAGE_LOGINTYPE)
...
_sym_db.RegisterEnumDescriptor(_PLAYERLISTMESSAGE_PLAYERLISTNOTIFICATION)
...
_sym_db.RegisterEnumDescriptor(_SUBSCRIPTIONREQUESTMESSAGE_SUBSCRIPTIONACTION)
...
_sym_db.RegisterEnumDescriptor(_JOINGAMEFAILEDMESSAGE_JOINGAMEFAILUREREASON)
...
_sym_db.RegisterEnumDescriptor(_GAMEPLAYERLEFTMESSAGE_GAMEPLAYERLEFTREASON)
...
_sym_db.RegisterEnumDescriptor(_REMOVEDFROMGAMEMESSAGE_REMOVEDFROMGAMEREASON)
...
_sym_db.RegisterEnumDescriptor(_REJECTGAMEINVITATIONMESSAGE_REJECTGAMEINVREASON)
...
_sym_db.RegisterEnumDescriptor(_STARTEVENTMESSAGE_STARTEVENTTYPE)
...
_sym_db.RegisterEnumDescriptor(_YOURACTIONREJECTEDMESSAGE_REJECTIONREASON)
...
_sym_db.RegisterEnumDescriptor(_ASKKICKDENIEDMESSAGE_KICKDENIEDREASON)
...
_sym_db.RegisterEnumDescriptor(_VOTEKICKREPLYMESSAGE_VOTEKICKREPLYTYPE)
...
_sym_db.RegisterEnumDescriptor(_ENDKICKPETITIONMESSAGE_PETITIONENDREASON)
...
_sym_db.RegisterEnumDescriptor(_STATISTICSMESSAGE_STATISTICSDATA_STATISTICSTYPE)
...
_sym_db.RegisterEnumDescriptor(_TIMEOUTWARNINGMESSAGE_TIMEOUTREASON)
...
_sym_db.RegisterEnumDescriptor(_REPORTAVATARACKMESSAGE_REPORTAVATARRESULT)
...
_sym_db.RegisterEnumDescriptor(_REPORTGAMEACKMESSAGE_REPORTGAMERESULT)
...
_ERRORMESSAGE_ERRORREASON = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='custReserved', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_ERRORMESSAGE_ERRORREASON)
...
_sym_db.RegisterEnumDescriptor(_ADMINREMOVEGAMEACKMESSAGE_ADMINREMOVEGAMERESULT)
...
_sym_db.RegisterEnumDescriptor(_ADMINBANPLAYERACKMESSAGE_ADMINBANPLAYERRESULT)
...
_sym_db.RegisterEnumDescriptor(_POKERTHMESSAGE_POKERTHMESSAGETYPE)
...
DESCRIPTOR.enum_types_by_name['NetGameMode'] = _NETGAMEMODE
DESCRIPTOR.enum_types_by_name['NetGameState'] = _NETGAMESTATE
DESCRIPTOR.enum_types_by_name['NetPlayerAction'] = _NETPLAYERACTION
DESCRIPTOR.enum_types_by_name['NetPlayerState'] = _NETPLAYERSTATE
DESCRIPTOR.enum_types_by_name['NetPlayerInfoRights'] = _NETPLAYERINFORIGHTS
DESCRIPTOR.enum_types_by_name['NetAvatarType'] = _NETAVATARTYPE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

NetGameInfo = _reflection.GeneratedProtocolMessageType('NetGameInfo', (_message.Message,), {
  'DESCRIPTOR' : _NETGAMEINFO,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:NetGameInfo)
  })
_sym_db.RegisterMessage(NetGameInfo)
...
AnnounceMessage = _reflection.GeneratedProtocolMessageType('AnnounceMessage', (_message.Message,), {
...
_sym_db.RegisterMessage(AnnounceMessage)
_sym_db.RegisterMessage(AnnounceMessage.Version)
...
AuthServerChallengeMessage = _reflection.GeneratedProtocolMessageType('AuthServerChallengeMessage', (_message.Message,), {
  'DESCRIPTOR' : _AUTHSERVERCHALLENGEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AuthServerChallengeMessage)
  })
_sym_db.RegisterMessage(AuthServerChallengeMessage)

AuthClientResponseMessage = _reflection.GeneratedProtocolMessageType('AuthClientResponseMessage', (_message.Message,), {
  'DESCRIPTOR' : _AUTHCLIENTRESPONSEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AuthClientResponseMessage)
  })
_sym_db.RegisterMessage(AuthClientResponseMessage)

AuthServerVerificationMessage = _reflection.GeneratedProtocolMessageType('AuthServerVerificationMessage', (_message.Message,), {
  'DESCRIPTOR' : _AUTHSERVERVERIFICATIONMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AuthServerVerificationMessage)
  })
_sym_db.RegisterMessage(AuthServerVerificationMessage)

InitAckMessage = _reflection.GeneratedProtocolMessageType('InitAckMessage', (_message.Message,), {
  'DESCRIPTOR' : _INITACKMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:InitAckMessage)
  })
_sym_db.RegisterMessage(InitAckMessage)

AvatarRequestMessage = _reflection.GeneratedProtocolMessageType('AvatarRequestMessage', (_message.Message,), {
  'DESCRIPTOR' : _AVATARREQUESTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AvatarRequestMessage)
  })
_sym_db.RegisterMessage(AvatarRequestMessage)

AvatarHeaderMessage = _reflection.GeneratedProtocolMessageType('AvatarHeaderMessage', (_message.Message,), {
  'DESCRIPTOR' : _AVATARHEADERMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AvatarHeaderMessage)
  })
_sym_db.RegisterMessage(AvatarHeaderMessage)

AvatarDataMessage = _reflection.GeneratedProtocolMessageType('AvatarDataMessage', (_message.Message,), {
  'DESCRIPTOR' : _AVATARDATAMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AvatarDataMessage)
  })
_sym_db.RegisterMessage(AvatarDataMessage)

AvatarEndMessage = _reflection.GeneratedProtocolMessageType('AvatarEndMessage', (_message.Message,), {
  'DESCRIPTOR' : _AVATARENDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AvatarEndMessage)
  })
_sym_db.RegisterMessage(AvatarEndMessage)

UnknownAvatarMessage = _reflection.GeneratedProtocolMessageType('UnknownAvatarMessage', (_message.Message,), {
  'DESCRIPTOR' : _UNKNOWNAVATARMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:UnknownAvatarMessage)
  })
_sym_db.RegisterMessage(UnknownAvatarMessage)

PlayerListMessage = _reflection.GeneratedProtocolMessageType('PlayerListMessage', (_message.Message,), {
...
GameListNewMessage = _reflection.GeneratedProtocolMessageType('GameListNewMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMELISTNEWMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameListNewMessage)
  })
_sym_db.RegisterMessage(GameListNewMessage)

GameListUpdateMessage = _reflection.GeneratedProtocolMessageType('GameListUpdateMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMELISTUPDATEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameListUpdateMessage)
  })
_sym_db.RegisterMessage(GameListUpdateMessage)

GameListPlayerJoinedMessage = _reflection.GeneratedProtocolMessageType('GameListPlayerJoinedMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMELISTPLAYERJOINEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameListPlayerJoinedMessage)
  })
_sym_db.RegisterMessage(GameListPlayerJoinedMessage)

GameListPlayerLeftMessage = _reflection.GeneratedProtocolMessageType('GameListPlayerLeftMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMELISTPLAYERLEFTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameListPlayerLeftMessage)
  })
_sym_db.RegisterMessage(GameListPlayerLeftMessage)

GameListSpectatorJoinedMessage = _reflection.GeneratedProtocolMessageType('GameListSpectatorJoinedMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMELISTSPECTATORJOINEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameListSpectatorJoinedMessage)
  })
_sym_db.RegisterMessage(GameListSpectatorJoinedMessage)

GameListSpectatorLeftMessage = _reflection.GeneratedProtocolMessageType('GameListSpectatorLeftMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMELISTSPECTATORLEFTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameListSpectatorLeftMessage)
  })
_sym_db.RegisterMessage(GameListSpectatorLeftMessage)

GameListAdminChangedMessage = _reflection.GeneratedProtocolMessageType('GameListAdminChangedMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMELISTADMINCHANGEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameListAdminChangedMessage)
  })
_sym_db.RegisterMessage(GameListAdminChangedMessage)

PlayerInfoRequestMessage = _reflection.GeneratedProtocolMessageType('PlayerInfoRequestMessage', (_message.Message,), {
  'DESCRIPTOR' : _PLAYERINFOREQUESTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:PlayerInfoRequestMessage)
  })
_sym_db.RegisterMessage(PlayerInfoRequestMessage)

PlayerInfoReplyMessage = _reflection.GeneratedProtocolMessageType('PlayerInfoReplyMessage', (_message.Message,), {

  'PlayerInfoData' : _reflection.GeneratedProtocolMessageType('PlayerInfoData', (_message.Message,), {

    'AvatarData' : _reflection.GeneratedProtocolMessageType('AvatarData', (_message.Message,), {
...
_sym_db.RegisterMessage(PlayerInfoReplyMessage)
_sym_db.RegisterMessage(PlayerInfoReplyMessage.PlayerInfoData)
_sym_db.RegisterMessage(PlayerInfoReplyMessage.PlayerInfoData.AvatarData)

SubscriptionRequestMessage = _reflection.GeneratedProtocolMessageType('SubscriptionRequestMessage', (_message.Message,), {
  'DESCRIPTOR' : _SUBSCRIPTIONREQUESTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:SubscriptionRequestMessage)
  })
_sym_db.RegisterMessage(SubscriptionRequestMessage)

JoinExistingGameMessage = _reflection.GeneratedProtocolMessageType('JoinExistingGameMessage', (_message.Message,), {
  'DESCRIPTOR' : _JOINEXISTINGGAMEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:JoinExistingGameMessage)
  })
_sym_db.RegisterMessage(JoinExistingGameMessage)

JoinNewGameMessage = _reflection.GeneratedProtocolMessageType('JoinNewGameMessage', (_message.Message,), {
  'DESCRIPTOR' : _JOINNEWGAMEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:JoinNewGameMessage)
  })
_sym_db.RegisterMessage(JoinNewGameMessage)

RejoinExistingGameMessage = _reflection.GeneratedProtocolMessageType('RejoinExistingGameMessage', (_message.Message,), {
  'DESCRIPTOR' : _REJOINEXISTINGGAMEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:RejoinExistingGameMessage)
  })
_sym_db.RegisterMessage(RejoinExistingGameMessage)

JoinGameAckMessage = _reflection.GeneratedProtocolMessageType('JoinGameAckMessage', (_message.Message,), {
  'DESCRIPTOR' : _JOINGAMEACKMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:JoinGameAckMessage)
  })
_sym_db.RegisterMessage(JoinGameAckMessage)

JoinGameFailedMessage = _reflection.GeneratedProtocolMessageType('JoinGameFailedMessage', (_message.Message,), {
  'DESCRIPTOR' : _JOINGAMEFAILEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:JoinGameFailedMessage)
  })
_sym_db.RegisterMessage(JoinGameFailedMessage)

GamePlayerJoinedMessage = _reflection.GeneratedProtocolMessageType('GamePlayerJoinedMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMEPLAYERJOINEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GamePlayerJoinedMessage)
  })
_sym_db.RegisterMessage(GamePlayerJoinedMessage)

GamePlayerLeftMessage = _reflection.GeneratedProtocolMessageType('GamePlayerLeftMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMEPLAYERLEFTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GamePlayerLeftMessage)
  })
_sym_db.RegisterMessage(GamePlayerLeftMessage)

GameSpectatorJoinedMessage = _reflection.GeneratedProtocolMessageType('GameSpectatorJoinedMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMESPECTATORJOINEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameSpectatorJoinedMessage)
  })
_sym_db.RegisterMessage(GameSpectatorJoinedMessage)

GameSpectatorLeftMessage = _reflection.GeneratedProtocolMessageType('GameSpectatorLeftMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMESPECTATORLEFTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameSpectatorLeftMessage)
  })
_sym_db.RegisterMessage(GameSpectatorLeftMessage)

GameAdminChangedMessage = _reflection.GeneratedProtocolMessageType('GameAdminChangedMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMEADMINCHANGEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameAdminChangedMessage)
  })
_sym_db.RegisterMessage(GameAdminChangedMessage)

RemovedFromGameMessage = _reflection.GeneratedProtocolMessageType('RemovedFromGameMessage', (_message.Message,), {
  'DESCRIPTOR' : _REMOVEDFROMGAMEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:RemovedFromGameMessage)
  })
_sym_db.RegisterMessage(RemovedFromGameMessage)

KickPlayerRequestMessage = _reflection.GeneratedProtocolMessageType('KickPlayerRequestMessage', (_message.Message,), {
  'DESCRIPTOR' : _KICKPLAYERREQUESTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:KickPlayerRequestMessage)
  })
_sym_db.RegisterMessage(KickPlayerRequestMessage)

LeaveGameRequestMessage = _reflection.GeneratedProtocolMessageType('LeaveGameRequestMessage', (_message.Message,), {
  'DESCRIPTOR' : _LEAVEGAMEREQUESTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:LeaveGameRequestMessage)
  })
_sym_db.RegisterMessage(LeaveGameRequestMessage)

InvitePlayerToGameMessage = _reflection.GeneratedProtocolMessageType('InvitePlayerToGameMessage', (_message.Message,), {
  'DESCRIPTOR' : _INVITEPLAYERTOGAMEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:InvitePlayerToGameMessage)
  })
_sym_db.RegisterMessage(InvitePlayerToGameMessage)

InviteNotifyMessage = _reflection.GeneratedProtocolMessageType('InviteNotifyMessage', (_message.Message,), {
  'DESCRIPTOR' : _INVITENOTIFYMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:InviteNotifyMessage)
  })
_sym_db.RegisterMessage(InviteNotifyMessage)

RejectGameInvitationMessage = _reflection.GeneratedProtocolMessageType('RejectGameInvitationMessage', (_message.Message,), {
  'DESCRIPTOR' : _REJECTGAMEINVITATIONMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:RejectGameInvitationMessage)
  })
_sym_db.RegisterMessage(RejectGameInvitationMessage)

RejectInvNotifyMessage = _reflection.GeneratedProtocolMessageType('RejectInvNotifyMessage', (_message.Message,), {
  'DESCRIPTOR' : _REJECTINVNOTIFYMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:RejectInvNotifyMessage)
  })
_sym_db.RegisterMessage(RejectInvNotifyMessage)

StartEventMessage = _reflection.GeneratedProtocolMessageType('StartEventMessage', (_message.Message,), {
  'DESCRIPTOR' : _STARTEVENTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:StartEventMessage)
  })
_sym_db.RegisterMessage(StartEventMessage)

StartEventAckMessage = _reflection.GeneratedProtocolMessageType('StartEventAckMessage', (_message.Message,), {
  'DESCRIPTOR' : _STARTEVENTACKMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:StartEventAckMessage)
  })
_sym_db.RegisterMessage(StartEventAckMessage)

GameStartInitialMessage = _reflection.GeneratedProtocolMessageType('GameStartInitialMessage', (_message.Message,), {
  'DESCRIPTOR' : _GAMESTARTINITIALMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:GameStartInitialMessage)
  })
_sym_db.RegisterMessage(GameStartInitialMessage)

GameStartRejoinMessage = _reflection.GeneratedProtocolMessageType('GameStartRejoinMessage', (_message.Message,), {

  'RejoinPlayerData' : _reflection.GeneratedProtocolMessageType('RejoinPlayerData', (_message.Message,), {
...
_sym_db.RegisterMessage(GameStartRejoinMessage)
_sym_db.RegisterMessage(GameStartRejoinMessage.RejoinPlayerData)

HandStartMessage = _reflection.GeneratedProtocolMessageType('HandStartMessage', (_message.Message,), {

  'PlainCards' : _reflection.GeneratedProtocolMessageType('PlainCards', (_message.Message,), {
...
_sym_db.RegisterMessage(HandStartMessage)
_sym_db.RegisterMessage(HandStartMessage.PlainCards)

PlayersTurnMessage = _reflection.GeneratedProtocolMessageType('PlayersTurnMessage', (_message.Message,), {
  'DESCRIPTOR' : _PLAYERSTURNMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:PlayersTurnMessage)
  })
_sym_db.RegisterMessage(PlayersTurnMessage)

MyActionRequestMessage = _reflection.GeneratedProtocolMessageType('MyActionRequestMessage', (_message.Message,), {
  'DESCRIPTOR' : _MYACTIONREQUESTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:MyActionRequestMessage)
  })
_sym_db.RegisterMessage(MyActionRequestMessage)

YourActionRejectedMessage = _reflection.GeneratedProtocolMessageType('YourActionRejectedMessage', (_message.Message,), {
  'DESCRIPTOR' : _YOURACTIONREJECTEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:YourActionRejectedMessage)
  })
_sym_db.RegisterMessage(YourActionRejectedMessage)

PlayersActionDoneMessage = _reflection.GeneratedProtocolMessageType('PlayersActionDoneMessage', (_message.Message,), {
  'DESCRIPTOR' : _PLAYERSACTIONDONEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:PlayersActionDoneMessage)
  })
_sym_db.RegisterMessage(PlayersActionDoneMessage)

DealFlopCardsMessage = _reflection.GeneratedProtocolMessageType('DealFlopCardsMessage', (_message.Message,), {
  'DESCRIPTOR' : _DEALFLOPCARDSMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:DealFlopCardsMessage)
  })
_sym_db.RegisterMessage(DealFlopCardsMessage)

DealTurnCardMessage = _reflection.GeneratedProtocolMessageType('DealTurnCardMessage', (_message.Message,), {
  'DESCRIPTOR' : _DEALTURNCARDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:DealTurnCardMessage)
  })
_sym_db.RegisterMessage(DealTurnCardMessage)

DealRiverCardMessage = _reflection.GeneratedProtocolMessageType('DealRiverCardMessage', (_message.Message,), {
  'DESCRIPTOR' : _DEALRIVERCARDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:DealRiverCardMessage)
  })
_sym_db.RegisterMessage(DealRiverCardMessage)

AllInShowCardsMessage = _reflection.GeneratedProtocolMessageType('AllInShowCardsMessage', (_message.Message,), {

  'PlayerAllIn' : _reflection.GeneratedProtocolMessageType('PlayerAllIn', (_message.Message,), {
...
_sym_db.RegisterMessage(AllInShowCardsMessage)
_sym_db.RegisterMessage(AllInShowCardsMessage.PlayerAllIn)

EndOfHandShowCardsMessage = _reflection.GeneratedProtocolMessageType('EndOfHandShowCardsMessage', (_message.Message,), {
  'DESCRIPTOR' : _ENDOFHANDSHOWCARDSMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:EndOfHandShowCardsMessage)
  })
_sym_db.RegisterMessage(EndOfHandShowCardsMessage)

EndOfHandHideCardsMessage = _reflection.GeneratedProtocolMessageType('EndOfHandHideCardsMessage', (_message.Message,), {
  'DESCRIPTOR' : _ENDOFHANDHIDECARDSMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:EndOfHandHideCardsMessage)
  })
_sym_db.RegisterMessage(EndOfHandHideCardsMessage)

ShowMyCardsRequestMessage = _reflection.GeneratedProtocolMessageType('ShowMyCardsRequestMessage', (_message.Message,), {
  'DESCRIPTOR' : _SHOWMYCARDSREQUESTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:ShowMyCardsRequestMessage)
  })
_sym_db.RegisterMessage(ShowMyCardsRequestMessage)

AfterHandShowCardsMessage = _reflection.GeneratedProtocolMessageType('AfterHandShowCardsMessage', (_message.Message,), {
  'DESCRIPTOR' : _AFTERHANDSHOWCARDSMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AfterHandShowCardsMessage)
  })
_sym_db.RegisterMessage(AfterHandShowCardsMessage)

EndOfGameMessage = _reflection.GeneratedProtocolMessageType('EndOfGameMessage', (_message.Message,), {
  'DESCRIPTOR' : _ENDOFGAMEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:EndOfGameMessage)
  })
_sym_db.RegisterMessage(EndOfGameMessage)

PlayerIdChangedMessage = _reflection.GeneratedProtocolMessageType('PlayerIdChangedMessage', (_message.Message,), {
  'DESCRIPTOR' : _PLAYERIDCHANGEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:PlayerIdChangedMessage)
  })
_sym_db.RegisterMessage(PlayerIdChangedMessage)

AskKickPlayerMessage = _reflection.GeneratedProtocolMessageType('AskKickPlayerMessage', (_message.Message,), {
  'DESCRIPTOR' : _ASKKICKPLAYERMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AskKickPlayerMessage)
  })
_sym_db.RegisterMessage(AskKickPlayerMessage)

AskKickDeniedMessage = _reflection.GeneratedProtocolMessageType('AskKickDeniedMessage', (_message.Message,), {
  'DESCRIPTOR' : _ASKKICKDENIEDMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AskKickDeniedMessage)
  })
_sym_db.RegisterMessage(AskKickDeniedMessage)

StartKickPetitionMessage = _reflection.GeneratedProtocolMessageType('StartKickPetitionMessage', (_message.Message,), {
  'DESCRIPTOR' : _STARTKICKPETITIONMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:StartKickPetitionMessage)
  })
_sym_db.RegisterMessage(StartKickPetitionMessage)

VoteKickRequestMessage = _reflection.GeneratedProtocolMessageType('VoteKickRequestMessage', (_message.Message,), {
  'DESCRIPTOR' : _VOTEKICKREQUESTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:VoteKickRequestMessage)
  })
_sym_db.RegisterMessage(VoteKickRequestMessage)

VoteKickReplyMessage = _reflection.GeneratedProtocolMessageType('VoteKickReplyMessage', (_message.Message,), {
  'DESCRIPTOR' : _VOTEKICKREPLYMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:VoteKickReplyMessage)
  })
_sym_db.RegisterMessage(VoteKickReplyMessage)

KickPetitionUpdateMessage = _reflection.GeneratedProtocolMessageType('KickPetitionUpdateMessage', (_message.Message,), {
  'DESCRIPTOR' : _KICKPETITIONUPDATEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:KickPetitionUpdateMessage)
  })
_sym_db.RegisterMessage(KickPetitionUpdateMessage)

EndKickPetitionMessage = _reflection.GeneratedProtocolMessageType('EndKickPetitionMessage', (_message.Message,), {
  'DESCRIPTOR' : _ENDKICKPETITIONMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:EndKickPetitionMessage)
  })
_sym_db.RegisterMessage(EndKickPetitionMessage)
...
_sym_db.RegisterMessage(StatisticsMessage.StatisticsData)
...
ChatRejectMessage = _reflection.GeneratedProtocolMessageType('ChatRejectMessage', (_message.Message,), {
  'DESCRIPTOR' : _CHATREJECTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:ChatRejectMessage)
  })
_sym_db.RegisterMessage(ChatRejectMessage)

DialogMessage = _reflection.GeneratedProtocolMessageType('DialogMessage', (_message.Message,), {
  'DESCRIPTOR' : _DIALOGMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:DialogMessage)
  })
_sym_db.RegisterMessage(DialogMessage)

TimeoutWarningMessage = _reflection.GeneratedProtocolMessageType('TimeoutWarningMessage', (_message.Message,), {
  'DESCRIPTOR' : _TIMEOUTWARNINGMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:TimeoutWarningMessage)
  })
_sym_db.RegisterMessage(TimeoutWarningMessage)

ResetTimeoutMessage = _reflection.GeneratedProtocolMessageType('ResetTimeoutMessage', (_message.Message,), {
  'DESCRIPTOR' : _RESETTIMEOUTMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:ResetTimeoutMessage)
  })
_sym_db.RegisterMessage(ResetTimeoutMessage)

ReportAvatarMessage = _reflection.GeneratedProtocolMessageType('ReportAvatarMessage', (_message.Message,), {
  'DESCRIPTOR' : _REPORTAVATARMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:ReportAvatarMessage)
  })
_sym_db.RegisterMessage(ReportAvatarMessage)

ReportAvatarAckMessage = _reflection.GeneratedProtocolMessageType('ReportAvatarAckMessage', (_message.Message,), {
  'DESCRIPTOR' : _REPORTAVATARACKMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:ReportAvatarAckMessage)
  })
_sym_db.RegisterMessage(ReportAvatarAckMessage)

ReportGameMessage = _reflection.GeneratedProtocolMessageType('ReportGameMessage', (_message.Message,), {
  'DESCRIPTOR' : _REPORTGAMEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:ReportGameMessage)
  })
_sym_db.RegisterMessage(ReportGameMessage)

ReportGameAckMessage = _reflection.GeneratedProtocolMessageType('ReportGameAckMessage', (_message.Message,), {
  'DESCRIPTOR' : _REPORTGAMEACKMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:ReportGameAckMessage)
  })
_sym_db.RegisterMessage(ReportGameAckMessage)
...
AdminRemoveGameMessage = _reflection.GeneratedProtocolMessageType('AdminRemoveGameMessage', (_message.Message,), {
  'DESCRIPTOR' : _ADMINREMOVEGAMEMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AdminRemoveGameMessage)
  })
_sym_db.RegisterMessage(AdminRemoveGameMessage)

AdminRemoveGameAckMessage = _reflection.GeneratedProtocolMessageType('AdminRemoveGameAckMessage', (_message.Message,), {
  'DESCRIPTOR' : _ADMINREMOVEGAMEACKMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AdminRemoveGameAckMessage)
  })
_sym_db.RegisterMessage(AdminRemoveGameAckMessage)

AdminBanPlayerMessage = _reflection.GeneratedProtocolMessageType('AdminBanPlayerMessage', (_message.Message,), {
  'DESCRIPTOR' : _ADMINBANPLAYERMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AdminBanPlayerMessage)
  })
_sym_db.RegisterMessage(AdminBanPlayerMessage)

AdminBanPlayerAckMessage = _reflection.GeneratedProtocolMessageType('AdminBanPlayerAckMessage', (_message.Message,), {
  'DESCRIPTOR' : _ADMINBANPLAYERACKMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:AdminBanPlayerAckMessage)
  })
_sym_db.RegisterMessage(AdminBanPlayerAckMessage)

PokerTHMessage = _reflection.GeneratedProtocolMessageType('PokerTHMessage', (_message.Message,), {
  'DESCRIPTOR' : _POKERTHMESSAGE,
  '__module__' : 'pokerth_pb2'
  # @@protoc_insertion_point(class_scope:PokerTHMessage)
  })
_sym_db.RegisterMessage(PokerTHMessage)


DESCRIPTOR._options = None
_NETGAMEINFO.fields_by_name['manualBlinds']._options = None
_PLAYERRESULT.fields_by_name['bestHandPosition']._options = None
_GAMELISTNEWMESSAGE.fields_by_name['playerIds']._options = None
_GAMELISTNEWMESSAGE.fields_by_name['spectatorIds']._options = None
_PLAYERINFOREQUESTMESSAGE.fields_by_name['playerId']._options = None
_GAMESTARTINITIALMESSAGE.fields_by_name['playerSeats']._options = None
